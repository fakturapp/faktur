        ...
        <CardContent className="p-6 space-y-6">
          <section className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground space-y-1 leading-relaxed">
              <p>Le site <strong className="text-foreground">Faktur</strong> est édité par :</p>
              <ul className="list-disc list-inside space-y-0.5 ml-2">
                <li>Nom : danbenba</li>
                <li>Statut : Personne physique</li>
                <li>Contact : contact@danbenba.dev</li>
                <li>Site web : danbenba.dev</li>
              </ul>
            </div>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Le directeur de la publication est danbenba, joignable à contact@danbenba.dev.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground space-y-1 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-0.5 ml-2">
                ...
                <li>Site web : ovhcloud.com</li>
              </ul>
              <p className="mt-2">
                Les serveurs sont situés en France, conformément au RGPD.
              </p>
            </div>
          </section>
