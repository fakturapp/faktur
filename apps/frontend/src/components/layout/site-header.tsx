...
const routeTitles: Record<string, string> = {
  ...
  '/dashboard/settings/fakturai': 'Faktur AI',
  '/dashboard/settings/fakturai/enable': 'Activation',
  '/dashboard/settings/fakturai/edit': 'Configuration IA',
  '/dashboard/settings/fakturai/usage': 'Utilisation IA',
  '/dashboard/settings/fakturai/manage': 'Abonnement',
  '/dashboard/upgrade': 'Passer a AI Pro',
