            ...
            <motion.div key="s1" {...stepSlide} className="space-y-3">
              ...
              {hasStripeConfigured ? (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-violet-400 bg-violet-400/10 px-1.5 py-0.5 rounded">Stripe</span>
                    </div>
                ...
                <div className="relative group/stripe">
                  ...
                  <div className="absolute -bottom-9 left-1/2 -translate-x-1/2 opacity-0 translate-y-1 group-hover/stripe:opacity-100 group-hover/stripe:translate-y-0 transition-all duration-200 pointer-events-none z-20 whitespace-nowrap px-3 py-1.5 rounded-xl bg-foreground text-background text-xs shadow-lg">
                    Configurez d&apos;abord Stripe dans Paramètres → Paiement
                  </div>
                </div>
              )}
